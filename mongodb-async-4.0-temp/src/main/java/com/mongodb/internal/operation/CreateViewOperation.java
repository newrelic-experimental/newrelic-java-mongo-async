...
public abstract class CreateViewOperation {
    ...
    private final String viewName = Weaver.callOriginal();
	...
	public Void execute(final WriteBinding binding) {
		...
		DatastoreParameters params = DatastoreParameters
                ...
                .collection(viewName)
                .operation(MongoUtil.OP_CREATE_VIEW)
	...
	public void executeAsync(final AsyncWriteBinding binding, final SingleResultCallback<Void> callback) {
		...
		if(binding.operationName == null) {
			binding.operationName = MongoUtil.OP_CREATE_VIEW;
		}
		if(binding.namespace == null) {
			binding.namespace = new MongoNamespace(databaseName, viewName);
		}
